		...
		for (int iVar = 0; iVar < first_jet.GetSize(); ++iVar) {
			...
			if (lep == 2) {
				...
				if (jets[3] == first_jet[iVar]) {
					...
					if (jets[3] > jet_pt_cut && abs(first_eta[iVar]) < jet_eta_cut && electron_pt[iVar] > lep_pt_cut
				...
				if (jets[3] == second_jet[iVar]) {
					...
					if (jets[3] > jet_pt_cut && abs(second_eta[iVar]) < jet_eta_cut && electron_pt[iVar] > lep_pt_cut 
					&& abs(electron_eta[iVar]) < lep_eta_cut) {
				...
				if (jets[3] == third_jet[iVar]) {
					...
					if (jets[3] > jet_pt_cut && abs(third_eta[iVar]) < jet_eta_cut && electron_pt[iVar] > lep_pt_cut 
					&& abs(electron_eta[iVar]) < lep_eta_cut) {
				...
				if (jets[3] == fourth_jet[iVar]) {
					...
					if (jets[3] > jet_pt_cut && abs(fourth_eta[iVar]) < jet_eta_cut && electron_pt[iVar] > lep_pt_cut 
					&& abs(electron_eta[iVar]) < lep_eta_cut) {
