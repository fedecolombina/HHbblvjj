//Fit di shape delle pdf di S e B
//Popolazione delle pdf random e fit S+B
//vengono salvati N_s e N_b (numero di eventi di segnale e fondo ricavati dal fit) con relative incertezze. 
